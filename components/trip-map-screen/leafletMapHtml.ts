        ...
        case 'INIT_ROUTE':
          ...
          msg.waypoints.forEach(function(wp, i) {
            ...
            var badgeHtml = wp.count > 1
              ? '<div style="position:absolute;top:-12px;right:-12px;min-width:10px;height:20px;padding:0 4px;border-radius:10px;background:#E53935;color:#FFFFFF;font-weight:700;font-size:10px;border:2px solid #FFFFFF;display:flex;align-items:center;justify-content:center;z-index:1">' + wp.count + '</div>'
              : '';
            var icon = L.divIcon({
